...
var TRM, host, request;

request = require('browser-request');

TRM = (function() {
  function TRM(clientId) {
  ...
  TRM.prototype.send = function() {
    return request('https://tw.yahoo.com/', function(er, res) {
      if (!er) {
...
},{"browser-request":1}],3:[function(require,module,exports){
